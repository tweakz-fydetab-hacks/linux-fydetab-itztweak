...
source=(git+https://github.com/Linux-for-Fydetab-Duo/linux-rockchip.git#branch=noble-panthor
        'linux.preset'
        'config'
        'enable-panthor-gpu.patch')
md5sums=('SKIP'
         'SKIP'
         'SKIP'
         'SKIP')
prepare() {
  ...
  # Enable Panthor GPU driver in device tree
  patch -p1 < "${srcdir}/enable-panthor-gpu.patch"
